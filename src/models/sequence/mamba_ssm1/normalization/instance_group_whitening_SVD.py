...
class InstanceGroupSVD(nn.Module):
    def __init__(self, num_features, num_groups=32, T=5, num_channels=0, dim=3, eps=1e-5, momentum=0.1, affine=True, mode=0,
       ...
       # print('InstanceGroupSVD --- num_groups=', self.num_groups, '--T=', self.T)
        if self.affine:
...
if __name__ == '__main__':
    ...
    dbn = InstanceGroupSVD(16, num_groups=4, T=5, affine=False, momentum=1.)
